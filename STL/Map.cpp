...
int main()
{
    map<int, int> m1; // map store the values in sorted order
    m1[1] = 10;
    m1[2] = 20;
    m1[3] = 30;
    m1[4] = 40;
    ...
    map<string, int> m{{"bhanu", 22}, {"shantanu", 12}, {"Aradhana", 14}};
    print_map(m);
    ...
    cout << m["bhanu"] << endl;
    cout << m["rabi"] << endl; // default value of not defined key is 0 in case of int
